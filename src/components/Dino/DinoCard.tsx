...
import dinoGif from "../../assets/dino-run.gif";
    ...
    return (
      <div className="col-md-3 col-sm-6 mb-5">
        {/* <Card className="card">
            ...
            <h5 className="card-header">{ this.state.dinoIndex }</h5>
            {this.state.imageLoading ? (
                <img src={dinoGif} style={{width: '5em', height: '5em' }} className="card-img-top rounded mx-auto d-block mt-2" alt="" />
            ) : null}
            <Sprite 
